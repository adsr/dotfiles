...
(gtk_accel_path "<Actions>/terminal-window/zoom-in" "<Primary>minus")
...
(gtk_accel_path "<Actions>/terminal-window/zoom-out" "<Primary>plus")
; (gtk_accel_path "<Actions>/terminal-window/set-title" "<Primary><Shift>s")
(gtk_accel_path "<Actions>/terminal-window/paste-selection" "<Primary><Shift>x")
